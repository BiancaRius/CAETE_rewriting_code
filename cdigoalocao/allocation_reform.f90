...
contains
    ...
    subroutine alloc (lm, rm, hm, sm, nind, height, &
        &bminc, dwood, sla, lm2, rm2, cw2)
        ...
        !não alterados pela função
        real(r_8), intent(in) :: dwood, sla !traits


        !OUTPUT_VARIABLES !**colocar todas as variáveis que vc precisa iterar**
        ...
        sap_ind = (sm/nind)*1.D3
        heart_ind = (hm/nind)*1.D3
        wood_ind = (sap_ind + heart_ind)
