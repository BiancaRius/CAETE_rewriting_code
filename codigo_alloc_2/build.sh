...
python -m numpy.f2py -h interf.pyf constants.f90 allocation_reform_bia.f90 program.f90 -m module_alloc_bia --overwrite-signature

# Este comando usa o interf.pyf e o codigo para gerar o módulo
python -m numpy.f2py interf.pyf -c constants.f90 allocation_reform_bia.f90 program.f90 
